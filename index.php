...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientCompany'] = "haTTmsW1Egs1q4ebRIdD";
        $headers['auth']['clientSecret'] = "NjQ1MGhhVFRtc1cxRWdzMXE0ZWJSSWREY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
